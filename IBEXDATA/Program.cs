...
builder.Services.AddScoped<ITenantDB, TenantDB>();
builder.Services.AddScoped<IApartmentService, ApartmentService>();
builder.Services.AddScoped<IApartmentDB, ApartmentDB>();
builder.Services.AddScoped<IPowerOfAttorneysDB, PowerOfAttorneysDB>();
builder.Services.AddScoped<IOwnerTenantDB, OwnerTenantDB>();
builder.Services.AddScoped<ITabusService, TabusService>();
builder.Services.AddScoped<ITabusDB, TabusDB>();
